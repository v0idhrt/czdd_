...
import { TrafficControl } from "@pbe/react-yandex-maps";

const Tools = ({ value, setSpeedColor }) => {
  ...
  return (
    <div className={styles.TrafficWrapper}>
            ...
            <div className={styles.TrafficVisual}>
                <div className={styles.TrafficBorder} style={{backgroundColor: getBorderColor(value)}}>
                    <div className={styles.TrafficValue}
                    style={{ backgroundColor: trafficColor}}>{value}</div>
                </div>
